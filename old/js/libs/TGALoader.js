...
THREE.TGALoader.prototype.parse = function (buffer) {
  ...
  function tgaCheckHeader(header) {
    switch (header.image_type) {
      ...
      case TGA_TYPE_RLE_INDEXED:
        if (
          ...
          console.error(
            'THREE.TGALoader.parse.tgaCheckHeader: Invalid type colormap data for indexed type'
          )
        }
        break
      ...
      case TGA_TYPE_RLE_GREY:
        if (header.colormap_type) {
          console.error(
            'THREE.TGALoader.parse.tgaCheckHeader: Invalid type colormap data for colormap type'
          )
        }
        break
      ...
      default:
        console.error(
          'THREE.TGALoader.parse.tgaCheckHeader: Invalid type " ' +
            header.image_type +
            '"'
        )
    }
    ...
    if (
      ...
      console.error(
        'THREE.TGALoader.parse.tgaCheckHeader: Invalid pixel size "' +
          header.pixel_size +
          '"'
      )
    }
  ...
  function getTgaRGBA(data, width, height, image, palette) {
    ...
    if (use_grey) {
      switch (header.pixel_size) {
        ...
        default:
          console.error(
            'THREE.TGALoader.parse.getTgaRGBA: not support this format'
          )
          break
      }
    } else {
